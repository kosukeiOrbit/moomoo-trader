...
POSITION_SIZE_USD: float = float(os.getenv("POSITION_SIZE_USD", "600"))  # 1ポジションあたりの固定額（ドル）
...
# --- ストップロス ---
ATR_SL_MULTIPLIER: float = 0.5        # SL = ATR × 0.5
ATR_TP_MULTIPLIER: float = 1.0        # TP = ATR × 1.0（R:R = 1:2）
